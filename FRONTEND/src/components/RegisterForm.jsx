  ...
  return (
    <div className="w-full max-w-md mx-auto p-8">
      <div className="text-center mb-8 transform transition-all duration-300">
        ...
        <p className="text-slate-500 mt-2">Join us and start shortening URLs</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="relative transform transition-all duration-300 ease-in-out">
          <label 
            className={`block text-sm font-semibold transition-all duration-200 ${
              focusedField === 'name' ? 'text-slate-800' : 'text-slate-600'
            }`}
            htmlFor="name"
          >
            Full Name
        ...
        <div className="relative transform transition-all duration-300 ease-in-out">
          ...
          <p className="mt-2 text-sm text-slate-500">Must be at least 6 characters long</p>
        </div>
